...
{
      17,     0,    -1,    -1,    17,    18,    14,    -1,    19,    -1,
      20,    -1,    22,    -1,    21,    -1,     7,     4,    -1,     8,
       3,    -1,     9,     3,    10,    11,     5,     6,     5,    -1,
       3,    15,    18,    -1
};
...
{
  "$end", "error", "$undefined", "VARIABLE", "FILENAME", "NUMBER",
  "COMPARATOR", "LOAD", "DUMP", "FILTER", "BY", "COLUMNID", "FOREACH",
  "GENERATE", "EOL", "'='", "$accept", "commands", "command",
  "load_filename", "dump_variable", "filter_by", "assignment", 0
};
#endif
...
{
     -15,     0,   -15,   -14,    -2,     1,     2,    -1,   -15,   -15,
     -15,   -15,     3,   -15,   -15,     4,   -15,   -15,     5,    10,
      11,    13,   -15
};
...
{
       2,    12,    13,     3,    14,    15,     3,     4,     5,     6,
       4,     5,     6,    16,    18,    20,    19,    21,    22,    17
};

static const yytype_uint8 yycheck[] =
{
       0,    15,     4,     3,     3,     3,     3,     7,     8,     9,
       7,     8,     9,    14,    10,     5,    11,     6,     5,    12
};
...
{
       0,    17,     0,     3,     7,     8,     9,    18,    19,    20,
      21,    22,    15,     4,     3,     3,    14,    18,    10,    11,
       5,     6,     5
};
...
#line 171 "parser.y"
    { 
			...
			(yyval.str) = var_values[(yyvsp[(1) - (3)].index)];
		;}
    break;
